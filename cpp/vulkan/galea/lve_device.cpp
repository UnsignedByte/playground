...
void LveDevice::pickPhysicalDevice() {
  ...
  for (int i = 0; i < deviceCount; i++) {
    ...
    scores[i] = isDeviceSuitable(device) << 1 + (props.deviceType == VkPhysicalDeviceType::VK_PHYSICAL_DEVICE_TYPE_DISCRETE_GPU); // 2 if suitable device, 3 if also a discrete gpu
  }
